...
**********************************/
/* 模拟编辑奖品数据 */
// Mock.mock(/\/dt\/Award_edit\.htm\?award\.id=/, function() {
	// return {
	// 	award: {
	// 		type: Random.natural(0, 2),
	// 		id: Random.natural(10000, 10000000),
	// 		name: Random.string("upper", 12),
	// 		duration: Random.natural(30, 50),
	// 		msg: '金币价格 "#coin#";商品名 "#title#";商品兑换码 "#code#";商品过期时间"#expireTime#";商品密码"#password#";',
	// 		pic: "http://wacai-file.b0.upaiyun.com/img/web/core/logo_5.png",
	// 		maxTimes: Random.natural(0, 100),
	// 		url: "",
			// extInfo: {
			// 	picUrl: ""
			// }
...
/* 模拟奖品列表数据 */
// Mock.mock(/\/dt\/Award_list\.htm\?pageInfo\.pageSize=\d*&pageInfo\.pageIndex=\d*/, function() {
// 	return {
// 		pageInfo: {
// 			firstRow: 1,
// 			lastRow: 50,
...
// 			name: Random.string("upper", 12),
// 			budget: "0.15448812",
// 			orderCount: Random.natural(5, 1000), 
// 			leftCount: Random.natural(5, 1000),
...
// $.ajax({
//     url: '/dt/Award_edit.htm?award.id=123123',
//     dataType: 'json',
